...
import type { ChatVoicePlayerDownloadUrlFetcher } from '@/hooks/messages/useChatVoicePlayer';
import { useChatVoicePlayer } from '@/hooks/messages/useChatVoicePlayer';
...
function isVoiceAttachment(att: ChatAttachment): boolean {
  if (att.attachmentType === 'VOICE') return true;
  return att.contentType.startsWith('audio/');
}
...
export function ChatVoiceMessage({
  ...
  const player = useChatVoicePlayer(
    attachment,
  ...
  const a11yLabel = [
    t('chat.voiceMessage'),
    player.isPlaying ? t('chat.playingVoice') : t('chat.playVoiceMessage'),
    ...
    <View style={styles.container}>
      ...
      <View style={styles.rightSection}>
        <Slider
          ...
          accessibilityLabel={t('chat.seekVoice')}
        />
